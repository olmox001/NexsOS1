...
#define INPUT_TYPE_RESIZE                                                      \
  3 /* window/desktop resized: event.resize.w/h (GFX-DYN-01) */
#define INPUT_TYPE_LOOK_CHANGED                                                \
  4 /* compositor style/theme/bg changed elsewhere                             \
