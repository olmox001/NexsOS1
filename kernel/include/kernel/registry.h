...
int registry_set(const char *key, const char *value, int owner_pid) NX_MUST_USE;
int registry_get(const char *key, char *buffer, size_t size) NX_MUST_USE;
...
int registry_key_is_virtual(const char *key) NX_MUST_USE;
...
int registry_enum(const char *prefix, char *buf, size_t size) NX_MUST_USE;
...
int registry_del(const char *key, int owner_pid) NX_MUST_USE;
...
int registry_caller_owner(void) NX_MUST_USE;

/* Syscall Handler */
long sys_registry(int op, const char *key, char *value, size_t size) NX_MUST_USE;
