 ...
 *
 * Policy / Style / Theme / Background are kept separate (see compositor_style.h).
 * This file holds the built-in presets and the active selection.  The compositor
 * reads compositor_style_active()/compositor_theme_active()/
...
static const compositor_background_t backgrounds[BG_COUNT] = {
    [BG_BLACK] = {.bg_color = 0xFF121212, .bg_top = 0xFF121212, .bg_bottom = 0xFF181818}, /* near-black anchor */
    [BG_RED] = {.bg_color = 0xFFB33A3A, .bg_top = 0xFF933030, .bg_bottom = 0xFFFF5454}, /* terracotta */
    [BG_GREEN] = {.bg_color = 0xFF3E8E5B, .bg_top = 0xFF33744B, .bg_bottom = 0xFF5ACE84}, /* forest emerald */
    [BG_YELLOW] = {.bg_color = 0xFFC9A227, .bg_top = 0xFFA58520, .bg_bottom = 0xFFFFEB39}, /* amber gold */
    /* the original desktop gradient (was on compositor_theme_t); default background. */
    [BG_BLUE] = {.bg_color = 0xFF143060, .bg_top = 0xFF142850, .bg_bottom = 0xFF1450A0}, /* nexs */
    [BG_MAGENTA] = {.bg_color = 0xFF8E44AD, .bg_top = 0xFF74388E, .bg_bottom = 0xFFCE63FB}, /* amethyst */
    [BG_CYAN] = {.bg_color = 0xFF2A9D8F, .bg_top = 0xFF228175, .bg_bottom = 0xFF3DE4CF}, /* teal */
    [BG_WHITE] = {.bg_color = 0xFFD8D8DC, .bg_top = 0xFFB1B1B4, .bg_bottom = 0xFFFFFFFF}, /* soft off-white */
    [BG_GRAY] = {.bg_color = 0xFF4A4A52, .bg_top = 0xFF3D3D43, .bg_bottom = 0xFF6B6B77}, /* cool slate */
    [BG_BRIGHT_RED] = {.bg_color = 0xFFE8604F, .bg_top = 0xFFBE4F41, .bg_bottom = 0xFFFF8B73}, /* coral */
    [BG_BRIGHT_GREEN] = {.bg_color = 0xFF52B788, .bg_top = 0xFF439670, .bg_bottom = 0xFF77FFC5}, /* mint */
    [BG_BRIGHT_YELLOW] = {.bg_color = 0xFFF2C94C, .bg_top = 0xFFC6A53E, .bg_bottom = 0xFFFFFF6E}, /* soft gold */
    [BG_BRIGHT_BLUE] = {.bg_color = 0xFF4A78C0, .bg_top = 0xFF3D629D, .bg_bottom = 0xFF6BAEFF}, /* sky, distinct from nexs blue */
    [BG_BRIGHT_MAGENTA] = {.bg_color = 0xFFB07CD1, .bg_top = 0xFF9066AB, .bg_bottom = 0xFFFFB4FF}, /* orchid */
    [BG_BRIGHT_CYAN] = {.bg_color = 0xFF56C9C9, .bg_top = 0xFF47A5A5, .bg_bottom = 0xFF7DFFFF}, /* aqua */
    [BG_BRIGHT_WHITE] = {.bg_color = 0xFFF5F5F7, .bg_top = 0xFFC9C9CB, .bg_bottom = 0xFFFFFFFF}, /* near white */
};
